        ...
        <div class="menu_title menu_dashboard"></div>
          ...
          <li class="item">
            ...
            <ul class="menu_items submenu">
              ...
              <a href="#" class="nav_link sublink">Staff Profile</a>
              <a href="#" class="nav_link sublink">Mentor Profile</a>
            </ul>
          </li>
          <!-- end -->
          ...
          <li class="item">
            <div href="#" class="nav_link submenu_item">
              ...
              <span class="navlink">Platinum</span>
              <i class="bx bx-chevron-right arrow-left"></i>
            </div>
            ...
            <ul class="menu_items submenu">
              ...
              <a href="#" class="nav_link sublink">Registration</a>
            </ul>
          </li>
          <!-- end -->
        </ul>
